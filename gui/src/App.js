        ...
        {view === 'list' && (
          <>
            ...
            <ul className="space-y-2">
              {tasks.map(task => (
                task.id === editingTaskId ? (
                  <li key={task.id} className="p-4 bg-gray-700/50 rounded-xl shadow-md">
                    <div className="mb-2">
                      <input
                        type="text"
                  ...
                  <li key={task.id} className="flex items-center justify-between p-4 bg-gray-700/50 rounded-xl shadow-md hover:shadow-lg transition-all duration-200">
                    ...
                    <div className="flex space-x-1">
                      <button
                        ...
                        className="text-blue-400 hover:text-blue-300 p-2 rounded-full hover:bg-blue-500/20 transition-all duration-200"
                      >
